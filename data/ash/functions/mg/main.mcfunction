# Fire gem stuff
execute as @e[scores={right_click_fire=1..},tag=!fire_gem_cool,nbt={SelectedItem: {tag: {fire_gem: 1b}}}] run function ash:mg/gems/fire_gem/fire
...
# Speed gem stuff
execute as @e[scores={right_click_speed=1..},tag=!speed_gem_cool,nbt={SelectedItem: {tag: {speed_gem: 1b}}}] run function ash:mg/gems/speed_gem/speed_ability
...
# Ice gem stuff
execute as @e[scores={right_click_ice=1..},tag=!ice_gem_cool,nbt={SelectedItem: {tag: {ice_gem: 1b}}}] run function ash:mg/gems/ice_gem/ice_gem_ability
...
# Float gem stuff
execute as @e[scores={right_click_float=1..},tag=!float_gem_cool,nbt={SelectedItem: {tag: {float_gem: 1b}}}] run function ash:mg/gems/float_gem/float_gem_ability
